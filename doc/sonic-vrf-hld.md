...
- [SONiC VRF support design spec draft](#SONiC-VRF-support-design-spec-draft)
  ...
  - [User scenarios](#User-scenarios)
    ...
    - [Add Loopback interface to a VRF](#Add-Loopback-interface-to-a-VRF)
...
- For backward compatiblity we still connect `Loopback0` device to default kernel loopback interface - "lo". But you can't change `Loopback0`'s vrf attribution.
